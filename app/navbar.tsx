...
export default function Navbar() {
  return (
    <>
      <div className="flex flex-col sm:flex-row text-lg sm:text-xl justify-evenly content-center bg-gray-800 opacity-70 transition-opacity duration-500 hover:opacity-100">
